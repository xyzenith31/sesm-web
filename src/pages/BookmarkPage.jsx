...
// Komponen Card Materi (sudah diubah)
const MaterialCard = ({ material, onSelect }) => {
    ...
    // Fallback untuk creator_avatar jika tidak ada
                            ...
                            <div className="flex justify-between items-center space-y-4 mb-8">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3 flex-wrap gap-y-2">
                                        {types.map(type => ( <FilterButton key={type} label={type.charAt(0).toUpperCase() + type.slice(1).replace(/_/g, ' ')} isActive={activeTypeFilter === type} onClick={() => setActiveTypeFilter(type)} /> ))}
