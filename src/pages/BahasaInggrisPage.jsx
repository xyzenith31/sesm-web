...
const BahasaInggrisIcon = () => (
    <svg viewBox="0 0 64 64" className="w-12 h-12 text-purple-500">
        ...
        <text x="32" y="45" fontSize="32" fill="currentColor" textAnchor="middle" fontWeight="bold">A</text>
        <path d="M42 20a10 10 0 0 1-20 0" stroke="currentColor" strokeWidth="3" fill="none"/>
    </svg>
);
...
// --- Data Bab ---
const biEngChapters = [
  { id: 1, title: 'Greetings and Introduction', progress: 85, Icon: BahasaInggrisIcon, iconBgColor: 'bg-purple-100' },
  { id: 2, title: 'Alphabet and Numbers', progress: 70, Icon: BahasaInggrisIcon, iconBgColor: 'bg-purple-100' },
  { id: 3, title: 'Colors, Fruits, and Animals', progress: 55, Icon: BahasaInggrisIcon, iconBgColor: 'bg-purple-100' },
  { id: 4, title: 'Simple Present Tense', progress: 25, Icon: BahasaInggrisIcon, iconBgColor: 'bg-purple-100' },
];

const BahasaInggrisPage = ({ onNavigate }) => {
  return (
      ...
      <div className="md:hidden flex flex-col h-screen">
        <header className="bg-sesm-teal pt-8 pb-4 px-6 rounded-b-[2.5rem] shadow-lg text-white">
            ...
            <div className="relative mb-4">
                ...
                <input type="text" placeholder="Search for English materials..." className="w-full bg-white text-gray-800 placeholder:text-gray-500 rounded-full py-3 pl-12 pr-4 text-sm border-none focus:outline-none focus:ring-2 focus:ring-white/50" />
            </div>
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold tracking-wide">BAHASA INGGRIS</h1>
                    <p className="text-sm opacity-90">Kurikulum SESM</p>
                </div>
                <FaLanguage size={40} className="opacity-80"/>
            </div>
        </header>
        <main className="flex-1 overflow-y-auto pt-6 pb-6 px-6">
            <h2 className="text-lg font-bold text-gray-800 mb-4">All chapters</h2>
            <div className="space-y-4">
              {biEngChapters.map(({ id, title, progress, Icon, iconBgColor }) => (
        ...
        <div className="w-full max-w-2xl mx-auto">
          <header className="bg-white p-6 rounded-2xl shadow-md mb-8">
              <div className="flex items-center mb-4">
                  ...
                  <div className="flex-1">
                      <h1 className="text-3xl font-bold text-sesm-deep tracking-wide">BAHASA INGGRIS</h1>
                      <p className="text-md text-gray-500">Kurikulum SESM</p>
                  </div>
                  <FaLanguage size={40} className="text-sesm-teal"/>
              </div>
          </header>
          <main>
              <h2 className="text-xl font-bold text-gray-800 mb-4 px-2">All chapters</h2>
              <div className="space-y-4">
                {biEngChapters.map(({ id, title, progress, Icon, iconBgColor }) => (
