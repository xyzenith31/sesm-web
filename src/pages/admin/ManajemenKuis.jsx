...
const ManajemenKuis = ({ onNavigate }) => {
    ...
    const fetchQuizzes = useCallback((selectIdAfterFetch = null) => {
        ...
        DataService.getAllQuizzes()
            ...
            .catch(err => {
                console.error(err);
                // Tampilkan notifikasi jika gagal load kuis
    ...
    const fetchDrafts = useCallback(async () => {
        try {
            ...
            // Tampilkan notifikasi jika gagal load draf
    ...
    const fetchQuizDetails = useCallback((quizId) => {
        ...
        DataService.getQuizDetailsForAdmin(quizId)
            ...
            .catch(err => {
                console.error(err);
                // Tampilkan notifikasi jika gagal load detail
    ...
    // Fungsi untuk menampilkan konfirmasi hapus kuis
    ...
    // Fungsi untuk menampilkan konfirmasi hapus semua soal
    ...
    // Fungsi yang dijalankan setelah konfirmasi hapus semua soal
    ...
    const handleSaveSettings = async (quizId, settings) => {
        try {
            ...
            fetchQuizzes(quizId); // Refresh data kuis untuk update info di list
        } catch (error) {
    ...
    const handleUpdateQuestion = async (questionId, updatedData) => {
        try {
            ...
            fetchQuizDetails(selectedQuiz.id); // Refresh detail
        } catch (error) {
    ...
    const handleContinueQuestionDraft = (quizId) => {
        ...
        if (quizToSelect) {
            ...
            setTimeout(() => setAddQuestionOpen(true), 100);
             ...
             // Tampilkan notifikasi jika kuis tidak ditemukan
