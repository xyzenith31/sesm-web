...
import QuizSubmissionDetailModal from '../../components/admin/QuizSubmissionDetailModal'; // ✅ Impor modal baru
...
const EvaluasiKuis = ({ onNavigate }) => {
    ...
    return (
        <>
            {/* ✅ Render modal saat ada submission yang dipilih */}
            <AnimatePresence>
                {selectedSubmission && (
                        ...
                        <div className="space-y-3">
                            {submissions.map((sub, index) => (
                                <motion.div
                                    ...
                                    onClick={() => setSelectedSubmission(sub)} // ✅ Buat baris bisa diklik
                                    className="bg-gray-50 border rounded-lg p-4 flex justify-between items-center hover:bg-gray-100 transition-colors cursor-pointer" // ✅ Tambah cursor-pointer
                                >
