...
import { FaLanguage } from 'react-icons/fa'; // Icon spesifik mapel
...
const BahasaInggrisPage = ({ onNavigate, onNavigateToWorksheet }) => {
    ...
    const HEADER_TITLE = 'B. INGGRIS';
    const ICON = FaLanguage;
    const THEME_STYLES = {
        color: 'text-purple-500',
        hoverBorder: 'hover:border-purple-300',
        bgGradient: 'from-purple-100 to-purple-200',
        desktopBg: 'bg-purple-50',
        desktopHeaderGradient: 'from-purple-400 to-purple-600',
        desktopTabBg: 'bg-purple-100/70',
        desktopTabText: 'text-purple-800'
    };
    const NAVIGATION_KEY = 'bahasaInggris';
    // ---------------------------
                ...
                >
                    <header className="p-6 flex-shrink-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div className='flex-grow'><h1 className="text-3xl font-bold text-sesm-deep tracking-wide">{HEADER_TITLE}</h1><p className='text-gray-500'>Learn English with fun!</p></div>
