...
import { FaFlask } from 'react-icons/fa'; // Icon spesifik mapel
...
const IPAPage = ({ onNavigate, onNavigateToWorksheet }) => {
    ...
    const THEME_STYLES = {
        ...
        desktopBg: 'bg-blue-50',
        desktopHeaderGradient: 'from-blue-400 to-blue-600',
        desktopTabBg: 'bg-blue-100/70',
        desktopTabText: 'text-blue-800'
    };
    const NAVIGATION_KEY = 'ipa';
    // ---------------------------
                ...
                >
                    <header className="p-6 flex-shrink-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div className='flex-grow'><h1 className="text-3xl font-bold text-sesm-deep tracking-wide">{HEADER_TITLE}</h1><p className='text-gray-500'>Jelajahi keajaiban sains!</p></div>
