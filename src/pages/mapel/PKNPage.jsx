...
const PknIcon = () => (
    <svg viewBox="0 0 64 64" className="w-12 h-12 text-yellow-500">
        ...
        <path d="M12 50h40" stroke="currentColor" strokeWidth="3" fill="none"/>
        <path d="M18 40l-8-12h16l-8 12zM46 40l-8-12h16l-8 12zM32 14v28" stroke="currentColor" strokeWidth="3" fill="none"/>
    </svg>
);
...
// --- Data Bab ---
const pknChapters = [
  { id: 1, title: 'Pancasila dan Simbol-simbolnya', progress: 95, Icon: PknIcon, iconBgColor: 'bg-yellow-100' },
  { id: 2, title: 'Hak dan Kewajiban Anak', progress: 80, Icon: PknIcon, iconBgColor: 'bg-yellow-100' },
  { id: 3, title: 'Aturan di Rumah dan di Sekolah', progress: 60, Icon: PknIcon, iconBgColor: 'bg-yellow-100' },
  { id: 4, title: 'Keberagaman Suku dan Budaya', progress: 35, Icon: PknIcon, iconBgColor: 'bg-yellow-100' },
];

const PKNPage = ({ onNavigate }) => {
  return (
      ...
      <div className="md:hidden flex flex-col h-screen">
        <header className="bg-sesm-teal pt-8 pb-4 px-6 rounded-b-[2.5rem] shadow-lg text-white">
            ...
            <div className="relative mb-4">
                ...
                <input type="text" placeholder="Cari materi PKN..." className="w-full bg-white text-gray-800 placeholder:text-gray-500 rounded-full py-3 pl-12 pr-4 text-sm border-none focus:outline-none focus:ring-2 focus:ring-white/50" />
            </div>
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold tracking-wide">PKN</h1>
                    <p className="text-sm opacity-90">Kurikulum SESM</p>
                </div>
                <FaBalanceScale size={40} className="opacity-80"/>
            </div>
        </header>
        <main className="flex-1 overflow-y-auto pt-6 pb-6 px-6">
            <h2 className="text-lg font-bold text-gray-800 mb-4">Semua bab</h2>
            <div className="space-y-4">
              {pknChapters.map(({ id, title, progress, Icon, iconBgColor }) => (
        ...
        <div className="w-full max-w-2xl mx-auto">
          <header className="bg-white p-6 rounded-2xl shadow-md mb-8">
              <div className="flex items-center mb-4">
                  ...
                  <div className="flex-1">
                      <h1 className="text-3xl font-bold text-sesm-deep tracking-wide">PKN</h1>
                      <p className="text-md text-gray-500">Kurikulum SESM</p>
                  </div>
                  <FaBalanceScale size={40} className="text-sesm-teal"/>
              </div>
          </header>
          <main>
