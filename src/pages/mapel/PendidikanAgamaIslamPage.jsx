...
// --- Data Bab ---
const paiChapters = [
  { id: 1, title: 'Rukun Iman dan Rukun Islam', progress: 75, Icon: PaiIcon, iconBgColor: 'bg-green-100' },
  { id: 2, title: 'Kisah Nabi dan Rasul', progress: 60, Icon: PaiIcon, iconBgColor: 'bg-green-100' },
  { id: 3, title: 'Belajar Huruf Hijaiyah', progress: 45, Icon: PaiIcon, iconBgColor: 'bg-green-100' },
  { id: 4, title: 'Tata Cara Wudhu dan Sholat', progress: 20, Icon: PaiIcon, iconBgColor: 'bg-green-100' },
];
      ...
      <div className="md:hidden flex flex-col h-screen">
        ...
        <main className="flex-1 overflow-y-auto pt-6 pb-6 px-6">
            ...
            <div className="space-y-4">
              {paiChapters.map(({ id, title, progress, Icon, iconBgColor }) => (
