// contoh-sesm-web/pages/mapel/PendidikanAgamaIslamPage.jsx
...
import { FaMosque } from 'react-icons/fa'; // Icon spesifik mapel
...
const PendidikanAgamaIslamPage = ({ onNavigate, onNavigateToWorksheet }) => {
    ...
    const THEME_STYLES = {
        ...
        desktopBg: 'bg-green-50',
        desktopHeaderGradient: 'from-green-400 to-green-600',
        desktopTabBg: 'bg-green-100/70',
        desktopTabText: 'text-green-800'
    };
    const NAVIGATION_KEY = 'pai';
    // ---------------------------
                ...
                >
                    <header className="p-6 flex-shrink-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div className='flex-grow'><h1 className="text-3xl font-bold text-sesm-deep tracking-wide">{HEADER_TITLE}</h1><p className='text-gray-500'>Pelajari dasar-dasar agama Islam.</p></div>
