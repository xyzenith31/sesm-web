// contoh-sesm-web/pages/mapel/MatematikaPage.jsx
...
const MatematikaPage = ({ onNavigate, onNavigateToWorksheet }) => {
    ...
    const THEME_STYLES = {
        ...
        desktopBg: 'bg-orange-50',
        desktopHeaderGradient: 'from-orange-400 to-orange-600',
        desktopTabBg: 'bg-orange-100/70',
                ...
                >
                    <header className="p-6 flex-shrink-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div className='flex-grow'><h1 className="text-3xl font-bold text-sesm-deep tracking-wide">{HEADER_TITLE}</h1><p className='text-gray-500'>Tingkatkan kemampuan matematikamu di sini!</p></div>
