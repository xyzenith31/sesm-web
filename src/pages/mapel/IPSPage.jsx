// contoh-sesm-web/pages/mapel/IPSPage.jsx
...
import { FaGlobeAmericas } from 'react-icons/fa'; // Icon spesifik mapel
...
// --- Halaman Utama Mapel ---
const IPSPage = ({ onNavigate, onNavigateToWorksheet }) => {
    const { user } = useAuth();
    ...
    const THEME_STYLES = {
        ...
        desktopBg: 'bg-sky-50',
        desktopHeaderGradient: 'from-sky-400 to-sky-600',
        desktopTabBg: 'bg-sky-100/70',
        desktopTabText: 'text-sky-800'
    };
    const NAVIGATION_KEY = 'ips';
    // ---------------------------
                ...
                >
                    <header className="p-6 flex-shrink-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div className='flex-grow'><h1 className="text-3xl font-bold text-sesm-deep tracking-wide">{HEADER_TITLE}</h1><p className='text-gray-500'>Pelajari tentang masyarakat dan lingkungan.</p></div>
