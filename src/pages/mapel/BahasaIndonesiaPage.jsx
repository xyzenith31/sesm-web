            ...
            <AnimatePresence>
             {hasCompleted && (
                 <motion.div
                    ...
                    className="absolute top-2 right-2 p-1.5 bg-yellow-400 rounded-full text-white shadow-md flex-shrink-0" 
...
const BahasaIndonesiaPage = ({ onNavigate, onNavigateToWorksheet }) => {
    ...
    const THEME_STYLES = {
        ...
        desktopBg: 'bg-red-50',
        desktopHeaderGradient: 'from-red-400 to-red-600',
        desktopTabBg: 'bg-red-100/70',
        desktopTabText: 'text-red-800'
    };
                ...
                >
                    <header className="p-6 flex-shrink-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div className='flex-grow'><h1 className="text-3xl font-bold text-sesm-deep tracking-wide">{HEADER_TITLE}</h1><p className='text-gray-500'>Pelajari Bahasa Indonesia lebih dalam.</p></div>
