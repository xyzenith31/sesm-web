    ...
    >
        ...
        <div className="mt-3 pt-3 border-t border-gray-200 flex space-x-4">
            <div className="flex items-center space-x-2"><FiTarget className="text-blue-500" />
                <div><p className="text-lg font-bold text-sesm-deep">{item.score}</p><p className="text-xs text-gray-500 -mt-1">Nilai</p></div>
            </div>
...
const DetailModal = ({ item, onClose }) => (
    ...
    >
        <motion.div
            ...
            className="bg-white rounded-2xl w-full max-w-lg max-h-[80vh] flex flex-col" onClick={(e) => e.stopPropagation()}
        >
