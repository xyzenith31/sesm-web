...
import { FaPencilAlt } from 'react-icons/fa'; // Icon spesifik mapel
...
const MenulisPage = ({ onNavigate, onNavigateToWorksheet }) => {
    ...
    const THEME_STYLES = {
        ...
        desktopBg: 'bg-pink-50',
        desktopHeaderGradient: 'from-pink-400 to-pink-600',
        desktopTabBg: 'bg-pink-100/70',
                ...
                >
                    <header className="p-6 flex-shrink-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div className='flex-grow'><h1 className="text-3xl font-bold text-sesm-deep tracking-wide">{HEADER_TITLE}</h1><p className='text-gray-500'>Latih kemampuan menulismu di sini!</p></div>
