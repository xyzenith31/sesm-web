    ...
    <>
      ...
      <div className="md:hidden">
        <div className="bg-gray-100 min-h-screen">
          <div className="bg-gradient-to-br from-sesm-teal to-sesm-deep text-white p-6 pb-8 rounded-b-3xl shadow-lg transition-colors duration-500">
      ...
      <div className="hidden md:flex justify-center py-12 px-8 min-h-screen bg-gray-100">
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          <div className="lg:col-span-1 space-y-8">
            <div className="bg-gradient-to-br from-sesm-teal to-sesm-deep text-white p-8 rounded-2xl shadow-lg transition-colors duration-500">
