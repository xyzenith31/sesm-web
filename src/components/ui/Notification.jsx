...
const Notification = ({
  ...
  return (
    <AnimatePresence>
      {/* Pastikan isOpen dicek lagi di dalam AnimatePresence */}
      {isOpen && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          // onClick={onClose} // <-- HAPUS onClick dari backdrop ini
        >
          <motion.div
            ...
            onClick={(e) => e.stopPropagation()} // Biarkan stopPropagation di sini
          >
            ...
            <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse rounded-b-2xl">
              {isConfirmation ? (
                <>
                  <button
                    onClick={onConfirm} // Tombol ini memanggil onConfirm
                    type="button"
                  ...
                  <button
                    onClick={onClose} // Tombol ini memanggil onClose
                    type="button"
